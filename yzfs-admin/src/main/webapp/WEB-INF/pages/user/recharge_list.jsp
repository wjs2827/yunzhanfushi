					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								...
								<div class="tools">
									<a href="javascript:initList();" class="reload"></a>
								</div>
							</div>
...
<![endif]-->
    ...
    function initList(){
 	   var submitForm=$("form[name=submitForm]")
           $.ajax({
        		url:"${contextPath}/admin/user/batchQueryAccountList",
        		type:"get",
        		...
        		success:function(response){
        		    ...
        		    if($(".tbodyClassOne tr").length==0){
        		        var newsTr="<tr><td class='red-text' style='text-align:center' colspan='7'>暂无数据显示!</td></tr>"
