								...
								<form id="role_add_form" class="form-horizontal">
									<div class="control-group" style="margin-top: 1rem">
										<label class="control-label">角色:</label> <input type="text"
											required="required" class="m-wrap span2" name="name"
											style="margin-left: 1.3rem" value="">
									</div>
									<div class="control-group">
										<label class="control-label">描述:</label>
										<textarea id="description" class="m-wrap"
											style="margin-left: 1.3rem; width: 414px;" rows="4" cols="80"></textarea>
									</div>
									<div class="control-group"
