					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="tools">
									<a href="javascript:initCommissionStatisList();" class="reload"></a>
							...
							<div class="portlet-body">
								<form action="" id="statisForm" name="statisForm" method="post">
									...
									<div class="controls_over" style="margin-left: -26rem;">
										<img src="${contextPath}/static/image/icon/search.png"
											...
											onclick="initCommissionStatisList();"
									...
									<div class="controls_over" style="margin-left: 1rem;">
										<input id="nickName" name="nickName" class="m-wrap" size="16"
											type="text" style="height: 17px;" placeholder="用户昵称/手机号"
											value="" />
									</div>
...
<![endif]-->
    ...
    jQuery(document).ready(function() {
        App.init();
        initCommissionStatisList();
    });
    
	//商品统计信息加载
	function initCommissionStatisList(){
		var statisForm=$("form[name=statisForm]");
	       $.ajax({
	    		url:contextPath+"/admin/statis/batchCommissionStatisList",
	    		type:"get",
	    		data:statisForm.serialize(),
	    		dataType:"html",
	    		beforeSend: function () {  
	    			onDialog();
	    		},
