					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="tools">
									<a href="javascript:initRechargeStatisList();" class="reload"></a>
								...
								<form action="" id="statisForm" name="statisForm" method="post">
									...
									<div class="controls_over" style="margin-left: -26rem;">
										<img src="${contextPath}/static/image/icon/search.png"
											...
											onclick="initRechargeStatisList();"
...
<![endif]-->
    ...
    jQuery(document).ready(function() {
        App.init();
        initRechargeStatisList();
    });
    
	//商品统计信息加载
	function initRechargeStatisList(){
		var statisForm=$("form[name=statisForm]");
	       $.ajax({
	    		url:contextPath+"/admin/statis/batchRechargeStatisList",
	    		type:"get",
