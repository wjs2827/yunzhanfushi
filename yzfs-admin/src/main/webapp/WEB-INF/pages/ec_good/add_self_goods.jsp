...
<body class="page-header-fixed page-footer-fixed">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<form class="form-horizontal" id="selfgoods" name="selfgoods"
									...
									<input type="hidden" id="desContent" name="desContent" /> <input
										type="hidden" id="spuType" name="spuType" value="0" /> <input
										type="hidden" id="neckTitleLength" name="neckTitleLength"
										value="0" /> <input type="hidden" id="neckLength"
										name="neckLength" value="0" /> <input type="hidden"
										id="isUnifiedSpecs" name="isUnifiedSpecs" value="0" /> <input
										type="hidden" id="skuTitleLength" name="skuTitleLength"
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span3 m-wrap" type="Number" id="rank"
												name="rank" style="width: 10rem;" onblur="onBlurGoodRank();" />
											<span class="help-inline" id="goodRankError">排序不填写默认为0</span>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input class="span3 m-wrap" type="text" id="spuCode"
												name="spuCode" style="width: 10rem;" /> <span
												class="help-inline" id="spuCodeError">必填项</span>
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span3 m-wrap" type="text" id="name"
												style="width: 50%" name="name" placeholder="请输入商品名称"
												onblur="onBlurGoodName();" /> <span class="help-inline"
												id="goodNameError">必填项</span>
										</div>
									</div>
									...
									<div id="whetherRefitDivClass"
										...
										style='border: 1px solid #e4e4ec; margin-left: 12rem; background: #f5f5f5; width: 80%; display: none;'>

									</div>
									<!-- 可改装 结束-->
									<!--是否可改装生成表格 -->
									<div class="control-group mt10" id="neckTalbe"
										style="display: none; margin-left: .8rem;">
									...
									<!-- 统一规格 结束-->
									<!-- 多规格开始-->
									<div id="dgespecDiv" style="display: none;">
										<div>
									...
									<div class="control-group">
										<label class="control-label">商品图片(186*216)：</label>
										<div class="fileupload fileupload-new Add_Img"
											...
											<div class="fileupload-new thumbnail"
												...
												<span class="btn btn-file"> <span
													class="fileupload-new"> <img id="spuKeys"
														src="${contextPath}/static/image/add.png"
														style="width: 64px; height: 50px;" class="fileupload-new" />
														<input type="hidden" id="spuKeysValue" name="spuKeysValue" />
												</span>
												</span>
											</div>
										</div>
									...
									<div class="control-group">
										<label class="control-label">商品banner(375*197)：</label>
										<div class="infile">
											<div class="Contro" id="contro_0">
												<input type="hidden" class="default"
													name="goodsPicses[0].id" /> <input type="hidden"
													class="default" name="goodsPicses[0].picKey" />
												<div class="fileupload fileupload-new Add_Img"
													data-provides="fileupload">
													<div class="fileupload-new thumbnail"
														style="width: 64px; height: 64px;">
														<span class="btn btn-file"> <span
															class="fileupload-new"> <img id="img_0"
									...
									<!-- ><input type="hidden" id="btn_summer_note_image"> -->
									<div class="control-group">
										<label class="control-label">商品详情 ：</label>
										<div id="summernote_1" style="margin-left: 15rem"></div>
									</div>
									<!-- 是否立即上架-->
									<div class='control-group'>
	...
	<script src="${contextPath}/static/js/ec_good/add_insert.js"></script>
	...
	<script>
 	...
 	//判断是否单独购买商品
     $("input[name=singleOrder]").on("click",function(){
    	 var checkbox = document.getElementById('checkboxSingle');
    	  if(checkbox.checked){
    	    $("#checkboxSingle").val(true);
    	  }else{
    		$("#checkboxSingle").val(false);
    	  }
     });
	   ...
	   function chooseFirstClass(){
		   ...
		   $.ajax({
	    	    ...
	    	    success: function(data){
	    	    	$("#parentId").append("<option value ='0'>一级分类</option>");
	   ...
	   function chooseSecondClass(id){
	      ...
	      $.ajax({
    		...
    		type:'post',
    		success:function(data){
    			$("#secondClassId").append("<option value ='0' id='0'>二级分类</option>");
   			    $.each(data,function (index,domEle){
		...
		function delPic(){
			$(".fileupload-deleteImg").each(function(m){
				...
				$(this).click(function(){
				 if(
							$("#img_"+m).attr("src")=="${contextPath}/static/image/add.png") {
