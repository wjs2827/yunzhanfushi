...
function dTree(objName) {
	...
	this.icon = {
		root			:basePath+ '/static/image/base.gif',
		folder			: basePath+'/static/image/folder.gif',
		folderOpen	    : basePath+'/static/image/folderopen.gif',
		node			: basePath+'/static/image/page.gif',
		empty			: basePath+'/static/image/empty.gif',
		line			: basePath+'/static/image/line.gif',
		join			: basePath+'/static/image/join.gif',
		joinBottom	    : basePath+'/static/image/joinbottom.gif',
		plus			: basePath+'/static/image/plus.gif',
		plusBottom	    : basePath+'/static/image/plusbottom.gif',
		minus			: basePath+'/static/image/minus.gif',
		minusBottom	    : basePath+'/static/image/minusbottom.gif',
		nlPlus			: basePath+'/static/image/nolines_plus.gif',
		nlMinus			: basePath+'/static/image/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
