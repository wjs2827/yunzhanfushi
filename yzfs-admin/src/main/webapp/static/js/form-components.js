var FormComponents = function () {
    ...
    var handleDateRangePickers = function () {
        ...
        function (start, end) {
            $('#form-date-range span').html(start.toString('yyyy,MMMM d') + ' - ' + end.toString('yyyy,MMMM d'));
        });

        $('#form-date-range span').html(Date.today().add({
            days: -29
        }).toString('yyyy,MMMM d') + ' - ' + Date.today().toString('yyyy,MMMM d'));
        ...
        function (start, end) {
            $('#form-date-range-modal span').html(start.toString('yyyy,MMMM d') + ' - ' + end.toString('yyyy,MMMM d'));
        });
